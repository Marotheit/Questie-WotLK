...
function Astrolabe:PlaceIconOnWorldMap( worldMapFrame, icon, continent, zone, xPos, yPos )
	...
	if ( nX and nY and (0 < nX and nX <= 1) and (0 < nY and nY <= 1) ) then
		if tonumber(GetCVar("miniWorldMap")) == 1 then
		icon:SetPoint("CENTER", worldMapFrame, "TOPLEFT", nX * worldMapFrame:GetWidth() * 0.572, -nY * worldMapFrame:GetHeight() * 0.57);
		elseif tonumber(GetCVar("miniWorldMap")) == 0 and tonumber(GetCVar("questPOI")) == 1 then
		icon:SetPoint("CENTER", worldMapFrame, "TOPLEFT", nX * worldMapFrame:GetWidth() * 0.69, -nY * worldMapFrame:GetHeight() * 0.69);
		else
